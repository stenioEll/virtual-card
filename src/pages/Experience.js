            ...
            <div className='p-2 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100'>
              ...
              <ol class="relative border-l border-gray-200 dark:border-teal-500">                  
                  <li class="mb-10 ml-4">
                      ...
                      <a href="#" class="inline-flex items-center rounded px-4 py-2 text-xs animate-jump-in font-medium animate-fade-up focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-teal-800 dark:text-gray-200 dark:border-gray-600 dark:hover:text-white dark:hover:bg-teal-700 dark:focus:ring-teal-700">Learn more <svg class="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></a>
                  </li>
                  <li class="mb-10 ml-4">
                      ...
                      <a href="#" class="inline-flex items-center rounded px-4 py-2 text-xs font-medium focus:z-10 animate-fade-up focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-teal-800 dark:text-gray-200 dark:border-gray-600 dark:hover:text-white dark:hover:bg-teal-700 dark:focus:ring-teal-700">Learn more <svg class="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></a>
                  </li>
              </ol>
